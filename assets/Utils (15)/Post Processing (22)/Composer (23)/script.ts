...
namespace PostEffects {
  ...
  export const Scanline = {
    uniforms: {
      "tDiffuse": { type: "t", value: null },
      "nightTime": { type: "f", value: 0 }
    },
  	vertexShader: Sup.get("Utils/Post Processing/Night Shader", Sup.Shader)["__inner"].vertexShader.text,
  	fragmentShader: Sup.get("Utils/Post Processing/Night Shader", Sup.Shader)["__inner"].fragmentShader.text
  };
}
